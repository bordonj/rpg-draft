...
describe('CharacterClasses', () => {
  ...
  test('should correctly create a character class object with different stats properties', () => {
    ...
    expect(characterClasses).toEqual({"assassin": {"type": "assassin", "def": 3, "hp": 70, "int": 10, "mp": 70, "res": 5, "spd": 8, "stl": 10, "str": 8}, "barbarian": {"type": "barbarian", "def": 10, "hp": 125, "int": 0, "mp": 30, "res": 2, "spd": 4, "stl": 3, "str": 10}, "mage": {"type": "mage", "def": 3, "hp": 50, "int": 10, "mp": 100, "res": 10, "spd": 4, "stl": 3, "str": 4}, "necromancer": {"type": "necromancer", "def": 5, "hp": 50, "int": 5, "mp": 100, "res": 9, "spd": 5, "stl": 5, "str": 5}});
  });
